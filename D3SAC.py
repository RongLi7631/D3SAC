...
def run_episode(env, rpm, rpm2):
    ...
    while True:
        ...
        for m in range(0, M):
            ...
            obs, reward, done, _, _, _, _, _, _, _, _ = env.step(m, b, f, [0] * 6, bs_list, md_list)
            if m == M - 1:
    ...
    for i in range(5):
        ...
        while True:
            ...
            for m in range(0, M):
                ...
                obs, reward, done, tcn, T1, E1, T1_pmax, E1_pmax, phi_p, phi_pmax, p = env.step(m, b, f, tcn, bs_list,
                                                                                                md_list)
                s_reward += reward
                sT1 += T1
                sE1 += E1
...
if __name__ == '__main__':
    ...
    for seed in SEED:
        ...
        while episode < max_episode:
            ...
            if eval_reward > best_reward:
                ...
                agent.alg.save_model('models/best_d3qn_model_{}.pth'.format(M))
                agent2.alg.save_model('models/best_sac_model_{}.pth'.format(M))
    ...
    with open("result/pytorch_md3qn_mSAC_p_t_{}.pickle".format(M), 'wb') as f:
        pickle.dump(ts, f)
    with open("result/pytorch_md3qn_mSAC_p_e_{}.pickle".format(M), 'wb') as f:
        pickle.dump(es, f)
    with open("result/pytorch_md3qn_mSAC_p_e_T1_{}.pickle".format(M), 'wb') as f:
        pickle.dump(es_T1, f)
    with open("result/pytorch_md3qn_mSAC_p_e_E1_{}.pickle".format(M), 'wb') as f:
        pickle.dump(es_E1, f)
    with open("result/pytorch_md3qn_mSAC_p_e_T1_pmax_{}.pickle".format(M), 'wb') as f:
        pickle.dump(es_T1_pmax, f)
    with open("result/pytorch_md3qn_mSAC_p_e_E1_pmax_{}.pickle".format(M), 'wb') as f:
        pickle.dump(es_E1_pmax, f)
    with open("result/pytorch_md3qn_mSAC_p_e_phi_p_{}.pickle".format(M), 'wb') as f:
        pickle.dump(es_phi_p, f)
    with open("result/pytorch_md3qn_mSAC_p_e_phi_pmax_{}.pickle".format(M), 'wb') as f:
        pickle.dump(es_phi_pmax, f)
    with open("result/pytorch_md3qn_mSAC_p_e_p_{}.pickle".format(M), 'wb') as f:
        pickle.dump(es_p, f)
    with open("result/pytorch_md3qn_mSAC_p_e_loss_{}.pickle".format(M), 'wb') as f:
        pickle.dump(loss, f)
    with open("result/pytorch_md3qn_mSAC_p_e_loss2_{}.pickle".format(M), 'wb') as f:
        pickle.dump(loss2, f)
    with open("result/pytorch_md3qn_mSAC_p_e_alpha_{}.pickle".format(M), 'wb') as f:
        pickle.dump(Alpha, f)
    if M == 20:
        with open("result/pytorch_md3qn_mSAC_p_TCN1.pickle", 'wb') as f:
            pickle.dump(TCN1, f)
        with open("result/pytorch_md3qn_mSAC_p_TCN2.pickle", 'wb') as f:
            pickle.dump(TCN2, f)
        with open("result/pytorch_md3qn_mSAC_p_TCN3.pickle", 'wb') as f:
            pickle.dump(TCN3, f)
        with open("result/pytorch_md3qn_mSAC_p_TCN.pickle", 'wb') as f:
            pickle.dump(TCN, f)
        with open("result/pytorch_md3qn_mSAC_p_res_F1.pickle", 'wb') as f:
            pickle.dump(res_F1, f)
        with open("result/pytorch_md3qn_mSAC_p_res_F2.pickle", 'wb') as f:
            pickle.dump(res_F2, f)
        with open("result/pytorch_md3qn_mSAC_p_res_F3.pickle", 'wb') as f:

...
if __name__ == '__main__':
    ...
    for model_M in Model_M:
        for seed in SEED:
            ...
            algorithm.load_model('models/best_d3qn_model_{}.pth'.format(model_M))
            ...
            algorithm2.load_model('models/best_sac_model_{}.pth'.format(model_M))
        ...
        with open("result/D3SAC_{}_{}.pickle".format(model_M, M), 'wb') as f:
            pickle.dump(es, f)
